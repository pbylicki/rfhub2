...
...                      Test Libdoc File     test_resource        test_robot
...
Left Panel For Single Library Should Contain Expected Keywords
    ...
    FOR    ${i}    IN RANGE    1    ${list_len}
        Run Keyword And Continue On Failure    Element Text Should Be    ${single_class_lib_items}/div[${i+1}]/div/a/div    @{keywords}[${i}]
    END
